...
export function AnalyticsChart() {
  ...
  const avgTherapies = (
    monthlyData.reduce((sum, d) => sum + d.therapies, 0) / monthlyData.length
  ).toFixed(1);
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:col-span-2">
        ...
        <Card className="shadow-card">
          <CardHeader>
            <CardTitle>Avg. Therapies</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-2xl font-bold">{avgTherapies}</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="shadow-card lg:col-span-2">
        <CardHeader>
          <CardTitle>Patient & Revenue Growth</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card className="shadow-card">
        <CardHeader>
          <CardTitle>Therapy Revenue</CardTitle>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width="100%" height={250}>
